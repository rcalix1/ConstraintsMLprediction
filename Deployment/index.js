...
async function runExample141() {
 ...
 <table>
  ...
  <td id="c1td2"> ${output[2].toFixed(2)} </td>
    ...
    <tr>
  <td> i_h2i_rate</td>
  <td id="c1td3"> ${ output[3].toFixed(2)   } </td>
  </tr>
  
  <tr>
  <td> i_h2_temp </td>
  <td id="c1td4"> ${output[4].toFixed(2)} </td>
  </tr> 

  <tr>
  <td> i_ngi_rate </td>
  <td id="c1td5"> ${output[5].toFixed(2)} </td>
  </tr> 

  <tr>
  <td> i_ngi_rate </td>
  <td id="c1td6"> ${output[6].toFixed(2)} </td>
  </tr> 
